...
public class BlockFlowing extends BlockFluid {
   ...
   public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
      ...
      if(var6 > 0) {
         ...
         int var12 = this.getSmallestFlowDecay(var1, var2 - 1, var3, var4, var10);
      ...
      if(this.liquidCanDisplaceBlock(var1, var2, var3 - 1, var4)) {
         ...
         if(this.blockMaterial == Material.lava) {
            Material var10000 = var1.getBlockMaterial(var2, var3 - 1, var4);
            var10001 = this.matInstance;
            if(var10000 == Material.water) {
   ...
   private boolean liquidCanDisplaceBlock(World var1, int var2, int var3, int var4) {
      ...
      if(var5 == this.blockMaterial) {
         ...
         Material var10001 = this.matInstance;
         return var5 == Material.lava?false:!this.blockBlocksFlow(var1, var2, var3, var4);
      }
   }
